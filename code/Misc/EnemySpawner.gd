...
func get_random_position():
	...
	var top_left = Vector2(player.global_position.x - vpr.x/2, player.global_position.x - vpr.y/2)
	var top_right = Vector2(player.global_position.x + vpr.x/2, player.global_position.x - vpr.y/2)
